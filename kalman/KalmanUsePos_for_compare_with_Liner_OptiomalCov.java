...
public class KalmanUsePos_for_compare_with_Liner_OptiomalCov{
	...
	public static void main(String[] args) throws Exception{
		...
		Matrix ProsessNoiseCov = new Matrix(
				new double[][]{{93.40606375778589 ,0.03944045965615798},
						{0.03944045965615798 , 7.862788414096715}}); /*{{ 0.5540341524701068, 0.03958970771784662, 0.039589692819525964,0.039589698114432394},
		...
		Matrix MeasurementNoiseCov = new Matrix(
				new double[][]
						...
						{0.05044045965914967 ,100.0504404596561 }});/*{{ 100.05074019856619,0.050740198730252886,0.050740197719993475,0.050740198905271476},
	...
	private static void write(String shipnum, String err,String culc_count) {
		...
		File errfile = new File("D:\\ais_2012\\for kalman\\total_err\\KalamnShipErrOnlyUsedPosWithOptimalCov.csv");
		try {
